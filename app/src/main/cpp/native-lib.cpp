...
Java_com_example_ys_orbtest_OrbTest_CVTest(JNIEnv *env, jobject instance, jlong matAddr) {
    ...
    if(!SLAM)
    {
        ...
        //SLAM = new ORB_SLAM2::System("/sdcard/Download/SLAM/VOC/ORBvoc.bin","/sdcard/Download/SLAM/Calibration/PARAconfig.yaml",ORB_SLAM2::System::MONOCULAR,false);
        ...
        //SLAM = new ORB_SLAM2::System("/storage/emulated/0/Android/data/com.example.ys.orbtest/files/SLAM/VOC/ORBvoc.bin","/storage/emulated/0/Android/data/com.example.ys.orbtest/files/SLAM/Calibration/PARAconfig.yaml",ORB_SLAM2::System::MONOCULAR,false);
